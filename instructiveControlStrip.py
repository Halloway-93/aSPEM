...
def run_trial(numberOfTrials, trial_index,p,q):
    ...
    # direction of the chosen arrow
    chosen_arrow = 2*stats.bernoulli.rvs(.5)-1
    ...
    core.wait(.5)#Wait 500 ms before moving
    ...
    p_up = p  # Probability of the band going right
    ...
    #Lower band stimuli  
    p_down= q  # Probability of the band going right
...
task_msg = 'In the task, please make a saccade toward the strip of the instructed direction\n UP or DOWN' + \
...
for i in range(numberOfTrials):
    run_trial(numberOfTrials, trial_index,p=0.9,q=0.1)
    trial_index += 1
