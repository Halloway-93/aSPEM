...
def run_trial(numberOfTrials, trial_index):
    ...
    button_size = 60  # Size of the arrow buttons
    ...
    upper_rdk = visual.DotStim(win, nDots=num_dots, dotSize=5, fieldSize=(band_width_px, band_height_px), dotLife=30,
                            color="white", coherence=0, dir=0, fieldPos=(0, int(win.size[1] / 8)),speed=1)
    ...
    p_up = 0.9  # Probability of the band going right
...
#red stimuli
    p_down= 0.1  # Probability of the band going right
...
task_msg = 'In the task, please select one color RED or GREEN with the up or down arrow\n' + \
    'on the keyboard, then make a saccade toward the strip with the selected color\n' + \
